...
function processHrefs(hrefs, volumeNumberAndDate, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const href of hrefs) {
            ...
            yield utils_1.fetchContentArrayBuffer(`${href}`, options)
                .then((result) => {
                ...
                const isPaywalled = paywallStyle === null || paywallStyle === void 0 ? void 0 : paywallStyle.includes('display: none');
                if (!utils_1.isNotNullish(isPaywalled))
