    ...
    await utils_1
      ...
      .then((result) => {
        ...
        if (lettersHeader) {
          ...
          const h1 =
            (_a =
              articleHeader === null || articleHeader === void 0
                ? void 0
                : articleHeader.firstChild) === null || _a === void 0
              ? void 0
              : _a.textContent;
          const h2 =
            (_b =
              articleHeader === null || articleHeader === void 0
                ? void 0
                : articleHeader.lastChild) === null || _b === void 0
              ? void 0
              : _b.textContent;
...
async function lrbParser(issueUrl) {
  ...
  return utils_1.fetchContent(issueUrl, options).then((result) => {
    ...
    const volumeNumberAndDate =
      ((_a =
        dateAndVolume === null || dateAndVolume === void 0
          ? void 0
          : dateAndVolume.firstChild) === null || _a === void 0
        ? void 0
        : _a.textContent) || new Date().toLocaleDateString();
