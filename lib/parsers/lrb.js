...
const processArticle = (articleHeader, articleDom, dom) => {
    var _a, _b, _c, _d, _e;
    const h1 = (_b = (_a = articleHeader.firstChild) === null || _a === void 0 ? void 0 : _a.textContent) !== null && _b !== void 0 ? _b : '';
    const h2 = (_d = (_c = articleHeader.lastChild) === null || _c === void 0 ? void 0 : _c.textContent) !== null && _d !== void 0 ? _d : '';
    ...
    const innerHTMLWithArticle = `${dom.window.document.body.innerHTML}<div><h1>${h1}</h1><h2>${h2}</h2></div><div>${reviewedItemsContent.innerHTML}</div><div>${(_e = body === null || body === void 0 ? void 0 : body.innerHTML) !== null && _e !== void 0 ? _e : ''}</div><br>End Article<br>`;
