...
const getSimpleArticleContent = (articleLayoutSimple) => {
    ...
    const title = simpleLayoutHeader === null || simpleLayoutHeader === void 0 ? void 0 : simpleLayoutHeader.querySelector('h1.title');
    ...
    const chapterTitle = (_a = title === null || title === void 0 ? void 0 : title.innerHTML) !== null && _a !== void 0 ? _a : 'No Chapter Title';
    return {
        chapterTitle: utils_1.clearNewlinesAndFormatting(chapterTitle),
        simpleLayoutHeader: (_b = simpleLayoutHeader === null || simpleLayoutHeader === void 0 ? void 0 : simpleLayoutHeader.outerHTML) !== null && _b !== void 0 ? _b : '',
        combinedContent,
    };
};
...
const processContent = (articleDom, dom) => {
    ...
    if (articleLayoutSimple) {
        const { chapterTitle, simpleLayoutHeader, combinedContent, } = getSimpleArticleContent(articleLayoutSimple);
...
function harpersParser(issueUrl) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newRefs = hrefs.filter((href) => href !== 'https://harpers.org/puzzles/');
        ...
        return processHrefs(newRefs, utils_1.clearNewlinesAndFormatting(volumeNumberAndDate), options);
    });
}
