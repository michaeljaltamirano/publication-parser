    ...
    for (const href of hrefs) {
        ...
        await utils_1.fetchContent(href, options)
            ...
            if (articleLayoutFeature) {
                const featureLayoutHeader = articleLayoutFeature.querySelector('.title-header.mobile');
                ...
                const articleTitle = featureLayoutHeader.querySelector('.article-title');
                const subheading = featureLayoutHeader.querySelector('.subheading');
                const subheadingMarkup = (subheading === null || subheading === void 0 ? void 0 : subheading.outerHTML) || '';
                ...
                const author = (byline === null || byline === void 0 ? void 0 : byline.innerText) || '';
                ...
                const combinedContent = Array.from(content).reduce((article, contentBlock) => {
