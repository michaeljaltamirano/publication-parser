    ...
    for (const href of hrefs) {
        ...
        `
            ...
            if (cleanContent.indexOf('<p><a href="https://www.google.com/url?q=https://shop.the-tls.co.uk/tls-latest-reviews')) {
                cleanContent = cleanContent.split('<p><a href="https://www.google.com/url?q=https://shop.the-tls.co.uk/tls-latest-reviews')[0];
            }
            if (cleanContent.indexOf('<p><a href="https://shop.the-tls.co.uk/tls-latest-reviews/')) {
                cleanContent = cleanContent.split('<p><a href="https://shop.the-tls.co.uk/tls-latest-reviews/')[0];
            }
            const contentBody = `
