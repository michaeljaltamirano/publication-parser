...
const processContent = (articleDom, dom) => {
    ...
    const titleAndAuthorMarkup = `<h2 class="chapter">${(_a = title === null || title === void 0 ? void 0 : title.innerHTML) !== null && _a !== void 0 ? _a : ''}</h2><h3>${(_b = author === null || author === void 0 ? void 0 : author.textContent) !== null && _b !== void 0 ? _b : ''}</h3><h3>${(_c = dek === null || dek === void 0 ? void 0 : dek.outerHTML) !== null && _c !== void 0 ? _c : ''}</h3>`;
